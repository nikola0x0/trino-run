...
export const SKY_Y = LANE_HEIGHT / 2;  // Sky at 100px (middle of top third)
export const GROUND_Y = (LANE_HEIGHT * 2) - 10;  // Ground at bottom of middle lane, slight offset from mole lane
export const UNDERGROUND_Y = GAME_HEIGHT - (LANE_HEIGHT / 2);  // Underground at 500px (middle of bottom third)
...
export const DINO_JUMP_HEIGHT = 80;
export const DINO_JUMP_VELOCITY = -400;
